...
<script>
    ...
    data () {
        return {
            ...
            bluKritzIcon: require('@/assets/icons/status_effects/kritz_blue.png'),
            redKritzIcon: require('@/assets/icons/status_effects/kritz_red.png'),
            ...
            burningIcon: require('@/assets/icons/burning.png'),
            controlPointIcons: {
